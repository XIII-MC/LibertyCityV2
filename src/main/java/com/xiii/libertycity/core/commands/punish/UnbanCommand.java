        ...
        if(command.getName().equalsIgnoreCase("unban")) {
            ...
            if(args.length == 1) {
                ...
                if(banList.isBanned(args[0])) {
                    ...
                    YMLUtil.log("UNBAN - " + target.getName() + " débanni par " + sender.getName(), "/server/punishments/", "/server/punishments/" + target.getUniqueId() + ".yml");
                ...
                if(banListIP.isBanned(((Player) target).getAddress().getHostName())) {
                    ...
                    YMLUtil.log("UNBAN - " + target.getName() + " débanni par " + sender.getName() + " | note: UNBAN_IP", "/server/punishments/", "/server/punishments/" + target.getUniqueId() + ".yml");
